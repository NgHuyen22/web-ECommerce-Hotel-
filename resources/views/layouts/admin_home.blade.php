...
<head>
	...
	<link rel="stylesheet" href="{{asset('admin/ad_css/app.css')}}">
	<link rel="stylesheet" href="{{asset('admin/ad_css/home.css')}}">
...
<body>
    ...
    <div class="wrapper">
         ...
         <div class="main">
                @include('admin.header')
					...
					@yield('add_room')
					@yield('room_detail')
					@yield('booking_management')
					@yield('bf_details')
					@yield('service_management')
					@yield('services')
					@yield('add_ldv')
					@yield('edit_ldv')
					@yield('sv_index')
	...
	<script src="{{asset('admin/ad_js/app.js')}}"></script>
	<script src="{{asset('admin/ad_js/sidebar.js')}}"></script>
